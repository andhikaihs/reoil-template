    ...
    <div class="container d-flex justify-content-between align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li class="dropdown"><a href="#"><img src="../assets/icon/user.png" height="14px" class="me-2">ADMIN<i class="bi bi-chevron-down dropdown-indicator"></i></a>
            <ul>
              <li><a href="../pages/Admin.php">Transaksi</a></li>
        ...
        <table class="table text-center">
            ...
            <tbody>
                <tr>
                  ...
                  <td>
                    <div class="dropdown">
                    <button class="btn btn-light dropdown-toggle" type="button" data-bs-toggle="dropdown">Menunggu Konfirmasi</button>
                    <ul class="dropdown-menu">
                        <li><a href="">Menunggu Konfirmasi</a></li>
                        <li><a href="">Permintaan Diterima</a></li>
                        <li><a href="">Kurir Menjemput</a></li>
                        <li><a href="">Diambil Kurir</a></li>
